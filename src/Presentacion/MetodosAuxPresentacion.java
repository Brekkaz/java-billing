 ...
 * @author Breyner
 */
public class MetodosAuxPresentacion {
        ...
        //DefaultTableModel(null,lCampos){public boolean isCellEditable(int rowIndex, int columIndex){return false;}}
    
    // <editor-fold defaultstate="collapsed" desc="Matriz De Verbel">
    /*public static String[][] matriz;
    public static int conta=0;
    public static void guardar(String[] v) {
        String[][] matrix = new String[conta+1][5];
        if (conta>0)
        {
        ...
        matrix = null;
        conta = conta +1;
//JOptionPane.showMessageDialog(null, "Guardado", "Campo Requerido ", JOptionPane.INFORMATION_MESSAGE);
}*/
// </editor-fold>
